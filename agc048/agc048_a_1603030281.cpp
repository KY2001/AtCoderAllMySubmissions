  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-10-18 23:11:21+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">2986 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">206 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">6288 KB</td>
					</tr>
...
./Main.cpp:87:5: warning: label ‘label2’ defined but not used [-Wunused-label]
   87 |     label2:;
      |     ^~~~~~
./Main.cpp:89:5: warning: label ‘label’ defined but not used [-Wunused-label]
   89 |     label:;
      |     ^~~~~
