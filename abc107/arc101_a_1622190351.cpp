...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    if (minus_init - K + 1 >= 0) {
      chmin(ans, abs(x[minus_init - K + 1]));
    }
    rep2(i, minus_init - K + 2, minus_init + 1) {
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-05-28 17:25:51+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3862 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
...
./Main.cpp:61:9: warning: ‘minus_init’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   61 |     int minus_init;
      |         ^~~~~~~~~~
