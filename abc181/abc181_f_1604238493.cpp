  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-01 22:48:13+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">3852 KB</td>
					</tr>
...
./Main.cpp:133:15: warning: suggest parentheses around ‘&&’ within ‘||’ [-Wparentheses]
  133 |       if (one and !two or R == 0 or L == 100) {
      |           ~~~~^~~~~~~~
