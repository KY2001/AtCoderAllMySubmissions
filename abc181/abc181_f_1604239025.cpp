  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-01 22:57:05+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4785 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">578 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">3880 KB</td>
					</tr>
...
./Main.cpp:133:15: warning: suggest parentheses around ‘&&’ within ‘||’ [-Wparentheses]
  133 |       if (one and !two or R == 0 or L == 200) {
      |           ~~~~^~~~~~~~
