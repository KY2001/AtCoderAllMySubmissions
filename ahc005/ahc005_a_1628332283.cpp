  ...
  //cout << score << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 19:31:23+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">15149011</td>
				</tr>
				<tr>
					<th>Code Size</th>
					<td class="text-center">7005 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
