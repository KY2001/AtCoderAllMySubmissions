  ...
  //cout << score << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 19:47:30+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">15158512</td>
				</tr>
				<tr>
					<th>Code Size</th>
					<td class="text-center">7042 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">2998 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">4468 KB</td>
					</tr>
