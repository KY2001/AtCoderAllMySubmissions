  ...
  //cout << score << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 19:58:31+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">15046685</td>
				</tr>
				<tr>
					<th>Code Size</th>
				...
				<tr>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">4480 KB</td>
					</tr>
