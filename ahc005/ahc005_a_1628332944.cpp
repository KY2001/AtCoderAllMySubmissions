  ...
  //cout << score << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 19:42:24+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">15250534</td>
				</tr>
				<tr>
					<th>Code Size</th>
				...
				<tr>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">4464 KB</td>
					</tr>
