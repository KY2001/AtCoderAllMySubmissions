  ...
  cout << ans << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 18:23:38+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">6314770</td>
				</tr>
				<tr>
					<th>Code Size</th>
					<td class="text-center">7178 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
...
./Main.cpp:116:18: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
  116 |     if (_sum(ok) == ok.size()) break;
      |                  ^
