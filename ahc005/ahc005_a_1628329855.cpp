...
signed main() {
  ...
  while (1) {
    ...
    if (time_duration.count() > 2.95) break;
  }
  cout << ret << endl;
}</pre>
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-08-07 18:50:55+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Score</th>
					<td class="text-center">12695746</td>
				</tr>
				<tr>
					<th>Code Size</th>
					<td class="text-center">7859 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">2964 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">4504 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In function ‘void dijkstra(long long int, long long int, long long int, V<std::__cxx11::basic_string<char> >&, VV<long long int>&, VV<long long int>&, std::priority_queue<std::vector<long long int, std::allocator<long long int> >, std::vector<std::vector<long long int, std::allocator<long long int> >, std::allocator<std::vector<long long int, std::allocator<long long int> > > >, std::greater<void> >&)’:
./Main.cpp:40:61: warning: unused parameter ‘distance’ [-Wunused-parameter]
   40 | void dijkstra(int x, int y, int dis, V<string> &c, VV<int> &distance, VV<int> &shortest_path, priority_queue<V<int>, VV<int>, greater<>> &pos) {
      |                                                    ~~~~~~~~~^~~~~~~~
./Main.cpp: In function ‘int main()’:
./Main.cpp:133:18: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
  133 |     if (_sum(ok) == ok.size()) break;
      |                  ^
