...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    cin >> s >> t;
    VV<int> char_ind(26);
    rep(i, s.size()) char_ind[s[i] - 'a'].emplace_back(i);
    int now = -1;
    int ans = 0;
    FOR(i, t) {
      if (char_ind[i - 'a'].empty()) {
        cout << -1 << endl;
        return;
      }
      int ind = Upper_bound(char_ind[i - 'a'], now);
      if (ind == -1) {
        ans += s.size() - now - 1;
        now = -1;
        ind = Upper_bound(char_ind[i - 'a'], now);
      }
      ans += char_ind[i - 'a'][ind] - now;
      now = char_ind[i - 'a'][ind];
    }
    cout << ans << endl;
  }
};
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-01-01 21:13:09+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc138/tasks/abc138_e">E - Strings of Impurity</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc138/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4579 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">4560 KB</td>
					</tr>
...
./Main.cpp:83:51:   required from here
./Main.cpp:56:24: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   56 |   if (0 <= ind and ind < A.size()) return ind;
