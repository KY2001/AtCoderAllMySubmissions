  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-09 09:05:24+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4519 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">420 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">36472 KB</td>
					</tr>
...
./Main.cpp:88:37: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   88 |           if ((0 <= right and right < row[i].size() and 0 <= right2 and right2 < row2[i].size())) {
      |                               ~~~~~~^~~~~~~~~~~~~~~
./Main.cpp:88:80: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   88 |           if ((0 <= right and right < row[i].size() and 0 <= right2 and right2 < row2[i].size())) {
      |                                                                         ~~~~~~~^~~~~~~~~~~~~~~~
./Main.cpp:93:44: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   93 |           } else if ((0 <= right and right < row[i].size())) {
      |                                      ~~~~~~^~~~~~~~~~~~~~~
./Main.cpp:97:35: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   97 |           if ((0 <= left and left < row[i].size() and 0 <= left2 and left2 < row2[i].size())) {
      |                              ~~~~~^~~~~~~~~~~~~~~
./Main.cpp:97:76: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   97 |           if ((0 <= left and left < row[i].size() and 0 <= left2 and left2 < row2[i].size())) {
      |                                                                      ~~~~~~^~~~~~~~~~~~~~~~
./Main.cpp:102:42: warning: comparison of integer expressi...