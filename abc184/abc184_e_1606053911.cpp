  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-22 23:05:11+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3373 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">3312 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">138352 KB</td>
					</tr>
...
./Main.cpp:87:17: warning: ‘Y’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   87 |     if (bfs[X][Y] == INF) {
      |                 ^
./Main.cpp:87:14: warning: ‘X’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   87 |     if (bfs[X][Y] == INF) {
      |              ^
