  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-23 09:32:18+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3035 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">299 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">27800 KB</td>
					</tr>
...
./Main.cpp:82:28: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   82 |       if (0 <= ind and ind <= b.size()) chmax(ans, i + b[ind]);
      |                        ~~~~^~~~~~~~~~~
