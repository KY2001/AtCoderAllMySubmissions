...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    while (pos.size()) {
      ...
      BFS(grid, bfs, x - 1, y, x, y);
      BFS(grid, bfs, x, y - 1, x, y);
      if ('a' <= grid[x][y] and grid[x][y] <= 'z' and not already[grid[x][y]]) {
        already[grid[x][y]] = true;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-22 23:09:30+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3468 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">374 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">138288 KB</td>
					</tr>
...
./Main.cpp:89:17: warning: ‘Y’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   89 |     if (bfs[X][Y] == INF) {
      |                 ^
./Main.cpp:89:14: warning: ‘X’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   89 |     if (bfs[X][Y] == INF) {
      |              ^
