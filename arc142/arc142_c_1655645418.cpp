    ...
    cout << "! " << ans << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-06-19 22:30:18+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4266 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">3924 KB</td>
					</tr>
...
./Main.cpp:78:30: warning: ‘ans’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   78 |         if (dis[i] == dis[ans] + d) {
      |                              ^
