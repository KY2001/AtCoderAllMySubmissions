    ...
    cout << "! " << ans << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-06-19 22:34:03+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4326 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
...
./Main.cpp:80:30: warning: ‘ans’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   80 |         if (dis[i] == dis[ans] + d) {
      |                              ^
