    ...
    if (zero == 2 and A + B + C >= 2) {
      ...
      rep(i, N) {
        ...
        if (abc[first] and abc[second] == 0) {
          abc[second] = 1;
          abc[first]  = 0;
          ans.emplace_back(abc2[second]);
        } else if (abc[first] == 0 and abc[second]) {
          abc[second] = 0;
          abc[first]  = 1;
          ans.emplace_back(abc2[first]);
        } else {
          abc[second]++;
          abc[first]--;
          ans.emplace_back(abc2[second]);
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-05-03 22:23:39+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3809 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">6724 KB</td>
					</tr>
