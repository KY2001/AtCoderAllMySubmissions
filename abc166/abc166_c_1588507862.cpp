  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-05-03 21:11:02+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc166/tasks/abc166_c">C - Peaks</a></td>
				</tr>
				<tr>
					<th>User</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">2097 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">96 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">9948 KB</td>
					</tr>
...
./Main.cpp:31:30: warning: comparison of integer expressions of different signedness: ‘long long unsigned int’ and ‘long long int’ [-Wsign-compare]
   31 |   for (unsigned int i = 0; i < digit; i++) {
      |                            ~~^~~~~~~
./Main.cpp: In static member function ‘static void CPeaks::solve(std::istream&, std::ostream&)’:
./Main.cpp:65:22: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   65 |         } else if (j == road[i].size() - 1) {
      |                    ~~^~~~~~~~~~~~~~~~~~~~~
