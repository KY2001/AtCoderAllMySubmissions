  ...
  static void solve(istream &cin, ostream &cout) {
    ...
    rep(i, N) {
      ...
      if (possible[A[i]].size() > 1) {
        ...
        cout << endl;
        possible[A[i]].emplace_back(i);
        sort(ALL(possible[A[i]]));
        cout << possible[A[i]].size() - 1 << " ";
        rep(j, possible[A[i]].size() - 1) cout << possible[A[i]][j + 1] + 1 << " ";
        cout << endl;
        return;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-05-08 21:38:02+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4179 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
