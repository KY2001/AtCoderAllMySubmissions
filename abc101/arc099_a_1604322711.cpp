...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    cout << CEIL(one, K - 1) + CEIL(N - one - 1, K - 1) << endl;
  }
};
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-02 22:11:51+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3173 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
...
./Main.cpp:88:39: warning: ‘one’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   88 |     cout << CEIL(one, K - 1) + CEIL(N - one - 1, K - 1) << endl;
      |                                     ~~^~~~~
