...
class BNotFound {
  public:
    static void solve(istream &cin, ostream &cout) {
        ...
        rfor(i, alph) rep(j, S.size()) if (i == S[j]) {
            break;
        }
        else if (j == S.size() - 1) {
            cout << i << endl;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-03-11 17:02:52+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc071/tasks/abc071_b">B - Not Found</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc071/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3503 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">3736 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In static member function ‘static void BNotFound::solve(std::istream&, std::ostream&)’:
./Main.cpp:46:20: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::__cxx11::basic_string<char>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   46 |         else if (j == S.size() - 1) {
      |                  ~~^~~~~~~~~~~~~~~
