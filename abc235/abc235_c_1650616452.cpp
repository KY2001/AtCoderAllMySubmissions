...
signed main() {
    ...
    rep(i, Q) {
        ...
        if (!search.count(x)) {
            cout << -1 << endl;
        } else if (search[x].size() < k) {
            cout << -1 << endl;
        } else {
            cout << search[x][k - 1] + 1 << endl;
        }
    }
}</pre>
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-04-22 17:34:12+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc235/tasks/abc235_c">C - The Kth Time Query</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc235/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3787 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">402 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">26616 KB</td>
					</tr>
...
./Main.cpp:63:37: warning: comparison of integer expressions of different signedness: ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
   63 |         } else if (search[x].size() < k) {
      |                    ~~~~~~~~~~~~~~~~~^~~
