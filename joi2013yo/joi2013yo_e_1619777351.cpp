    ...
    rep(i, N) {
      rep2(j, Lower_bound_reverse(x, x1[i]), Lower_bound(x, x2[i]))
          rep2(k, Lower_bound_reverse(y, y1[i]), Lower_bound(y, y2[i]))
              rep2(l, Lower_bound_reverse(x, d1[i]), Lower_bound(d, d2[i]))
                  cnt[j][k][l]++;
    }
    int ans = 0;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-04-30 19:09:11+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4489 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
