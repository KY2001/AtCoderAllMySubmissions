  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-02-26 08:27:36+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3894 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In static member function ‘static void BManyOranges::solve(std::istream&, std::ostream&)’:
./Main.cpp:11:13: error: expected primary-expression before ‘long’
   11 | #define int long long
      |             ^~~~
./Main.cpp:18:55: note: in definition of macro ‘rep2’
   18 | #define rep2(i, a, b) for (int i = (int)(a), i##_len=(b); i < i##_len; i++)
      |                                                       ^
./Main.cpp:58:20: note: in expansion of macro ‘int’
   58 |         rep2(i, 1, int(1e7)) {
      |                    ^~~
./Main.cpp:11:13: error: expected ‘)’ before ‘long’
   11 | #define int long long
      |             ^~~~
./Main.cpp:18:55: note: in definition of macro ‘rep2’
   18 | #define rep2(i, a, b) for (int i = (int)(a), i##_len=(b); i < i##_len; i++)
...
./Main.cpp:58:20: note: in expansion of macro ‘int’
   58 |         rep2(i, 1, int(1e7)) {
      |                    ^~~
./Main.cpp:18:54: note: to match this ‘(’
   18 | #define rep2(i, a, b) for (int i = (int)(a), i##_len=(b); i < i##_len; i++)
      |                                                      ^
./Main.cpp:58:9: note: in expansion of macro ‘rep2’
   58 |         rep2(i, 1, int(1e7)) {
      |         ^~~~
