...
void product(vector<int> &change, int now = 0) {
  if (now == a.size()) {
    int ret = 1;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-11-07 09:03:19+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">7217 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In function ‘void product(std::vector<long long int>&, long long int)’:
./Main.cpp:212:11: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
  212 |   if (now == a.size()) {
      |       ~~~~^~~~~~~~~~~
./Main.cpp: In static member function ‘static void CCreamPuff::solve(std::istream&, std::ostream&)’:
./Main.cpp:245:34: warning: comparison of integer expressions of different signedness: ‘__gnu_cxx::__alloc_traits<std::allocator<long long int>, long long int>::value_type’ {aka ‘long long int’} and ‘__gnu_cxx::__alloc_traits<std::allocator<long unsigned int>, long unsigned int>::value_type’ {aka ‘long unsigned int’} [-Wsign-compare]
  245 |       } else if (a[a.size() - 1] != prime_factor[i]) {
