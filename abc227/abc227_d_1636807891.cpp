...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    rfor(i, A) cin >> i;
    sort(all(A));
    priority_queue<int, V<int>, greater<>> B;
    deque<int> C(N - K);
    rep3(i, N - 1, N - K) B.push(A[i]);
    rep(i, N - K) C[i] = A[i];
    int ans            = 0;
    int cost           = 0;
    while (1) {
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-11-13 21:51:31+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc227/tasks/abc227_d">D - Project Planning</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc227/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4297 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">7944 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In static member function ‘static void DProjectPlanning::solve(std::istream&, std::ostream&)’:
./Main.cpp:62:20: warning: comparison of integer expressions of different signedness: ‘std::deque<long long int>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
   62 |       if (C.size() < cnt) break;
      |           ~~~~~~~~~^~~~~
./Main.cpp:81:20: warning: comparison of integer expressions of different signedness: ‘std::deque<long long int>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
   81 |       if (C.size() < cnt) break;
      |           ~~~~~~~~~^~~~~
