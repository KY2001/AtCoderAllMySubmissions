...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    rfor(i, A) cin >> i;
    sort(all(A));
    priority_queue<int, V<int>, greater<int>> B;
    V<int> C(N - K);
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-11-13 21:34:52+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3843 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">48 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">7060 KB</td>
					</tr>
...
./Main.cpp:61:20: warning: comparison of integer expressions of different signedness: ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
   61 |       if (C.size() < cnt) break;
      |           ~~~~~~~~~^~~~~
