...
signed main() {
  ...
  rep(i, N) {
    ...
    int val = seg.get_max(0, where[wh[i][1] - 1] + 1) + 1;
    chmax(ans, val);
  ...
  cout << ans << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-09-10 14:41:29+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4570 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">72 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">13164 KB</td>
					</tr>
...
./Main.cpp:83:28:   required from here
