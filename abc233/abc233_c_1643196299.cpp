...
class CProduct {
  public:
    static void solve(istream &cin, ostream &cout) {
        ...
        int ans  = 0;
        auto dfs = [&](auto self, int i, int A) {
            if (i == N) {
                if (A == X) ans++;
                return;
            }
            rfor(j, a[i]) {
                if (j > 1e18 / A) continue;
                self(self, i + 1, A * j);
            }
        };
        int A = 1;
        ...
        cout << ans << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-01-26 20:24:59+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc233/tasks/abc233_c">C - Product</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc233/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3940 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
