...
signed main() {
    ...
    cin >> A >> B >> C;
    rep2(n, 1, INF) {
        double t  = 1 / (PI * C) * (n * PI + acos(-A / (PI * B * C)));
        ...
        if (ft >= 100 - EPS) {
            ...
            double L = 1 / (PI * C) * ((n - 1) * PI + acos(-A / (PI * B * C))), R = t;
            while (R - L > EPS) {
                double mid = (L + R) / 2;
                double res = A * mid + B * sin(C * mid * PI);
                if (res <= 100) {
                    L = mid;
                } else {
                    R = mid;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-05-25 17:48:45+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/abc026/tasks/abc026_d">D - 高橋君ボール1号</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/abc026/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view ky's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
...
./Main.cpp:56:25: error: ‘R’ was not declared in this scope
   56 |                 cout << R << endl;
      |                         ^
