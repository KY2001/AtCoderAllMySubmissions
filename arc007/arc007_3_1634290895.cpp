  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-10-15 18:41:35+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/arc007/tasks/arc007_3">C - 節約生活</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/arc007/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view ky's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4677 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In static member function ‘static void C::solve(std::istream&, std::ostream&)’:
./Main.cpp:93:14: warning: suggest explicit braces to avoid ambiguous ‘else’ [-Wdangling-else]
   93 |           if (cnt == 1) rep(k, i) if (comb[k] == j) {
      |              ^
