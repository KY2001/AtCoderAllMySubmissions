...
public:
  static void solve(std::istream &cin, std::ostream &cout) {
    ...
    cout << temp[(K - first)% num - 1 + first] << endl;
  }
};
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-05-10 21:24:22+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">2026 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">199 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">18560 KB</td>
					</tr>
...
./Main.cpp:64:39: warning: ‘first’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   64 |     cout << temp[(K - first)% num - 1 + first] << endl;
      |                  ~~~~~~~~~~~~~~~~~~~~~^~~~~~~
