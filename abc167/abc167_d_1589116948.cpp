  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-05-10 22:22:28+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">2119 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">169 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">18556 KB</td>
					</tr>
...
./Main.cpp:65:32: warning: ‘num’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   65 |       cout << temp[(K - first) % num + first] << endl;
      |                    ~~~~~~~~~~~~^~~~~
./Main.cpp:65:38: warning: ‘first’ may be used uninitialized in this function [-Wmaybe-uninitialized]
   65 |       cout << temp[(K - first) % num + first] << endl;
      |                    ~~~~~~~~~~~~~~~~~~^~~~~~~
