...
bool cross(double x1, double y1, double x2, double y2, double X1, double Y1, double X2, double Y2) {
  double a = (x1 - x2) * (Y1 - y1) - (y1 - y2) * (X1 - x1);
  double b = (x1 - x2) * (Y2 - y1) - (y1 - y2) * (X2 - x1);
