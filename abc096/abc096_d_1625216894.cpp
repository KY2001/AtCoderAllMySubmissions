...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    cin >> N;
    V<int> primes;
    rep(i, 5 * (55555 + 1)) if (is_prime(i)) primes.emplace_back(i);
    V<int> ans;
    FOR(i, primes) {
      if (ans.size() == N) break;
      if (ans.size() < 4) {
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-07-02 18:08:14+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4660 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">3740 KB</td>
					</tr>
...
./Main.cpp:97:22: warning: comparison of integer expressions of different signedness: ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
