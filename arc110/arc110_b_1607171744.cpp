...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    if (not contain(T, S)) {
      ...
      cout << 2 * _pow(10, 10) << endl;
    } else if (T == "0") {
      cout << _pow(10, 10) << endl;
    } else {
      if (T.substr(0, 2) == "11") {
        cout << _pow(10, 10) - (_ceil(N, 3) - 1) << endl;
      } else if (T.substr(0, 2) == "10") {
        cout << _pow(10, 10) - (_ceil(N + 1, 3) - 1) << endl;
      } else {
        cout << _pow(10, 10) - (_ceil(N + 2, 3) - 1) << endl;
      }
    }
  }
};
