...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    rep(i, N) check[i][N - 1] = 1;
    rep(i, N) check[N - 1][i] = 1;
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-05-03 02:10:35+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">5487 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">209 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">131724 KB</td>
					</tr>
...
./Main.cpp:100:7:   required from here
...
./Main.cpp:100:7:   required from here
./Main.cpp:48:24: warning: comparison of integer expressions of different signedness: ‘long long int’ and ‘std::vector<long long int, std::allocator<long long int> >::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   48 |   if (0 <= ind and ind < A.size()) return ind;
