...
class B {
  public:
    static void solve(istream &cin, ostream &cout) {
        ...
        int X, K;
        cin >> X >> K;
        if (to_string(X + 1).size() <= K) {
            cout << _pow(10, K) << endl;
        } else if ((X + 1) % _pow(10, K) == 0) {
            cout << X + 1 << endl;
        } else {
            cout << (X + 1) - ((X + 1) % _pow(10, K)) + _pow(10, K) << endl;
        }
    }
};
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-12-23 17:38:40+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/yahoo-procon2018-qual/tasks/yahoo_procon2018_qual_b">B - オークション</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/yahoo-procon2018-qual/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3495 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Memory</th>
						<td class="text-center">3708 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In static member function ‘static void B::solve(std::istream&, std::ostream&)’:
./Main.cpp:42:37: warning: comparison of integer expressions of different signedness: ‘std::__cxx11::basic_string<char>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
   42 |         if (to_string(X + 1).size() <= K) {
      |             ~~~~~~~~~~~~~~~~~~~~~~~~^~~~
