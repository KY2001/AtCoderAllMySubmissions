  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-10-11 23:36:09+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4335 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">712 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">7620 KB</td>
					</tr>
...
./Main.cpp:110:32: warning: suggest parentheses around comparison in operand of ‘&’ [-Wparentheses]
  110 |               if ((j >> k) & 1 == 1) {
      |                              ~~^~~~
./Main.cpp:128:20: warning: comparison of integer expressions of different signedness: ‘std::vector<long long int>::size_type’ {aka ‘long unsigned int’} and ‘long long int’ [-Wsign-compare]
  128 |       if (w.size() == num) {
      |           ~~~~~~~~~^~~~~~
