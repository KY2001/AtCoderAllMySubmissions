...
public:
  static void solve(istream &cin, ostream &cout) {
    ...
    rep(i, M) cin >> lv[i].first >> lv[i].second;
    sort(ALL(lv));
  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-10-12 00:01:25+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4364 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">1148 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">7704 KB</td>
					</tr>
