  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-01-02 01:50:23+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">4497 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">266 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">41264 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp: In instantiation of ‘SegmentTree<T>::SegmentTree(std::vector<_Tp>&) [with T = int]’:
./Main.cpp:93:30:   required from here
./Main.cpp:52:14: warning: comparison of integer expressions of different signedness: ‘int’ and ‘std::vector<int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   52 |     while (n < v.size()) n *= 2;
./Main.cpp:54:23: warning: comparison of integer expressions of different signedness: ‘int’ and ‘std::vector<int>::size_type’ {aka ‘long unsigned int’} [-Wsign-compare]
   54 |     for (int i = 0; i < v.size(); i++) data[i + n - 1] = v[i];
