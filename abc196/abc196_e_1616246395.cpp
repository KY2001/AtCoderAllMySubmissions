  ...
  return 0;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-03-20 22:19:55+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">5684 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">2239 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">1052936 KB</td>
					</tr>
...
./Main.cpp:94:34: warning: value computed is not used [-Wunused-value]
   94 |       if (max[i] == -INF) max[i] == INF;
./Main.cpp:95:33: warning: value computed is not used [-Wunused-value]
   95 |       if (min[i] == INF) max[i] == -INF;
./Main.cpp: In instantiation of ‘long long int Upper_bound(std::vector<_Tp>&, T) [with T = long long int]’:
./Main.cpp:110:41:   required from here
...
./Main.cpp:111:49:   required from here
