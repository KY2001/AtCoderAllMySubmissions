...
class A {
  public:
    static void solve(istream &cin, ostream &cout) {
        ...
        rep(i, N) {
            cin >> p;
            rep(j, 11) if (p % _pow(10, j) != 0) chmin(ans, j - 1);
        }
        cout << ans << endl;
    }
};
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2021-12-23 17:29:49+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/bitflyer2018-final-open/tasks/bitflyer2018_final_a">A - 値札</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/bitflyer2018-final-open/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3519 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
