        ...
        if (q == 1) {
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-04-27 17:48:39+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/past202112-open/tasks/past202112_g">G - Connectivity</a></td>
				</tr>
				<tr>
					<th>User</th>
					<td class="text-center"><a href="/users/KY2001">KY2001</a> <a href='/contests/past202112-open/submissions?f.User=KY2001'><span class='glyphicon glyphicon-search black' aria-hidden='true' data-toggle='tooltip' title='view KY2001's submissions'></span></a></td>
				</tr>
				<tr>
					<th>Language</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">14894 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">31 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">4044 KB</td>
					</tr>
				...
				<h4>Compile Error</h4>
				<pre>./Main.cpp:198:33: warning: use of ‘auto’ in parameter declaration only available with ‘-fconcepts’
  198 |         void edge_update(int s, auto g) {
      |                                 ^~~~
./Main.cpp:220:35: warning: use of ‘auto’ in parameter declaration only available with ‘-fconcepts’
  220 |         bool try_reconnect(int s, auto f) {
      |                                   ^~~~
./Main.cpp: In instantiation of ‘void dynamic_connectivity<T>::euler_tour_tree::push(dynamic_connectivity<T>::euler_tour_tree::np) [with T = long long int; dynamic_connectivity<T>::euler_tour_tree::np = dynamic_connectivity<long long int>::euler_tour_tree::node*]’:
./Main.cpp:150:13:   required from ‘void dynamic_connectivity<T>::euler_tour_tree::splay(dynamic_connectivity<T>::euler_tour_tree::np) [with T = long long int; dynamic_connectivity<T>::euler_tour_tree::np = dynamic_connectivity<long long int>::euler_tour_tree::node*]’
./Main.cpp:242:13:   required from ‘void dynamic_connectivity<T>::euler_tour_tree::edge_connected_update(long long int, bool) [with T = long long int]’
./Main.cpp:317:42:   required from ‘bool dynamic_connectivity<T>::cut(long long int, long long int) [with T = long long int]’
./Main.cpp:387:28:   required from here
./Main.cpp:134:22: warning: unused parameter ‘t’ [-Wunused-parameter]
  134 |         void push(np t) {
      |                   ~~~^
