    ...
    cout << shortest[idx] << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2022-04-27 18:07:18+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
					<td class="text-center"><a href="/contests/past202112-open/tasks/past202112_i">I - Direct Elevator</a></td>
				</tr>
				<tr>
					<th>User</th>
				...
				<tr>
					...
					<tr>
						<th>Exec Time</th>
						<td class="text-center">2907 ms</td>
					</tr>
					<tr>
						<th>Memory</th>
						<td class="text-center">34816 KB</td>
					</tr>
