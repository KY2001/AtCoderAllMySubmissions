...
public:
  static void solve(std::istream &cin, std::ostream &cout) {
    ...
    int ans = 1;
    for (auto &i : counter) {
      if (i.first.first == 0 and i.first.second == 0) {
        ans += i.second;
      } else if (i.first.first == 0 or i.first.second == 0) {
        ans *= (bpm(2, counter[{0, 1}]) + bpm(2, counter[{1, 0}]) - 1);
        counter[{0, 1}] = 0;
        counter[{1, 0}] = 0;
      } else {
    ...
    cout << mod(ans - 1, MOD) << endl;
			...
			<div class="panel panel-default"><table class="table table-bordered table-striped">
				<tr>
					...
					<td class="text-center"><time class='fixtime fixtime-second'>2020-05-18 23:27:06+0900</time></td>
				</tr>
				<tr>
					<th>Task</th>
				...
				<tr>
					<th>Code Size</th>
					<td class="text-center">3191 Byte</td>
				</tr>
				<tr>
					<th>Status</th>
